  ...
  <form class="form-horizontal" role="form" method="post" action="">
     ...
     <div class="form-group">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-4">
            ...
            <input type="hidden" name="hinhanh" id="hinhanh" value="<?php echo $sanpham['hinh'] ?>" />
          </div>
       ...
       <div class="form-group">
          ...
          <div class="col-sm-4">
            <input type="date" class="form-control" name="ngaycapnhat" id="ngaycapnhat" value="<?php echo $sanpham['ngaycapnhat'] ?>">
          </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        ...
        echo form_textarea($data,$sanpham['chitietsp']);
        ?>
      </div>      
    </div>
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <input type="submit" class="btn btn-success" value="Cập Nhật" name="capnhat"></button>
      </div>
    </div>
  </form>
