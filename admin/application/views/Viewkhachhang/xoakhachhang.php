...
<h2>Thông Tin Khách Hàng</h2>
  <form class="form-horizontal" role="form" method="post" action="<?php echo base_url('khach-hang/thuc-hien-xoa/'.$khachhang['idkhachhang']) ?>"> 
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <input type="submit" class="btn btn-success" value="Xoa" name="xoa"></button>
      </div>
    </div>
  </form>
